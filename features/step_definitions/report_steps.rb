Given('I am in the evaluations screen') do
    visit evaluations_path
end

Given('I am in the management screen') do
    visit manager_path
end
...
Given('I have a form for discipline "Estrutura de Dados", with professor "DANIEL DE PAULA PORTO" and semester "2020.1"') do
    ...
    discipline = Discipline.create(name: "Estrutura de Dados", code: "CIC0090", professor_registration: "000", semester_id: 1)
