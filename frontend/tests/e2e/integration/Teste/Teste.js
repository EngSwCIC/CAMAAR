...
Before({ tags: '@interceptingRequest'},() => {
  ...
  let aux = [{"id":1,"code":"TA","semester":"2021.2","time":"35T45","subject_id":1,"created_at":"2023-01-19T18:43:43.097Z","updated_at":"2023-01-19T18:43:43.097Z","subject":{"id":1,"code":"CIC0097","name":"BANCO DE DINHEIRO","created_at":"2023-01-19T18:43:42.950Z","updated_at":"2023-01-19T18:43:42.950Z"}}]
  //cy.intercept('GET', '/api/members/1/cclasses').as('getRequest2')
  cy.intercept('GET', '/api/surveys/teste', surveys.survey_list[0])
  cy.intercept('GET', '/api/members/1/cclasses', aux).as('teste');

})

And(`clico em acesar no questionario "{}"`, (string) => {
