...
Cenario: Um professor tenta visualizar relatorio de turma qua ainda não fez avaliacoes
...
Cenario: Um professor consegue abrir relatorio de uma de suas turmas
  Dado que o professor já esteja logado
  E clique em visulizar relatorio de uma de suas turmas que ainda não tenha notas cadastradas
