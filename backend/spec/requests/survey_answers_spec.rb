...
RSpec.describe "/survey_answers", type: :request do
  ...
  # SurveyAnswersController, or in your router and rack
  ...
  describe "GET /index" do
    it "renders a successful response" do
      ...
      get survey_answers_url, headers: valid_headers, as: :json
  ...
  describe "POST /create" do
      ...
      it "creates a new SurveyAnswer" do
        expect {
          post survey_answers_url,
               params: { survey_answer: valid_attributes }, headers: valid_headers, as: :json
    ...
    context "with invalid parameters" do
      ...
      it "renders a JSON response with errors for the new survey_answer" do
        post survey_answers_url,
             params: { survey_answer: invalid_attributes }, headers: valid_headers, as: :json
    ...
    context "with valid parameters" do
      ...
      it "updates the requested survey_answer" do
        ...
        patch survey_answer_url(survey_answer),
              params: { survey_answer: new_attributes }, headers: valid_headers, as: :json
  ...
  describe "DELETE /destroy" do
    it "destroys the requested survey_answer" do
      survey_answer = SurveyAnswer.create! valid_attributes
      expect {
        delete survey_answer_url(survey_answer), headers: valid_headers, as: :json
      }.to change(SurveyAnswer, :count).by(-1)
    end
  end
end
